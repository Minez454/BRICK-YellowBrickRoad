...
if (agencyCount.count === 0) {
  ...
  const agencies = [
    ...
    ['Nevada Homeless Alliance', 'services',
      'Coordinating the Continuum of Care for homelessness in Southern Nevada — case management, housing navigation.',
...
if (resourceCount.count === 0) {
  ...
  const resources = [
    ...
    ['Family Promise Meals', 'food', 36.1654, -115.1354, '701 N 9th St', 'Meals for families in need', 'Call for schedule', '(702) 384-3582'],
